...
//Function for getting the number of pokemons in the data store based on the id
for (x in PokemonList.pokemon){
  numberOfPokemons=numberOfPokemons+1;//Since indexing starts from 0. we use +1
}

//------------Function for printing the pokemon details when name is given--------------//
//console.log("Function-1: Input is the name of the pokemon\n\n");

//Takes the pokemon name from the user
function pokInformation(pokeName,PokemonList) {//Takes the inputs: pokemon name and the data store
  for (var i = 0; i < numberOfPokemons; i++) {
    if(PokemonList.pokemon[i].name==pokeName){
      console.log(PokemonList.pokemon[i]);
    }
  }
}
//--------------------------------------------------------//
...
//---------Function to give the name of pokemon when its next evolution is given-------//
//console.log("Function-2: Input is the next_evolution pokemon\n\n");
//Takes in the pokemon name from user
function pre_evolution(pokeName,PokemonList) {
  //Takes inputs:Pokemon name and the data store
  for (var j in PokemonList.pokemon) {
    for (var k in PokemonList.pokemon[j].next_evolution) {
      if(PokemonList.pokemon[j].next_evolution[k].name==pokeName){
        console.log(PokemonList.pokemon[j].name);
      }
    }
  }
}
...
//-----------Function for getting pokemon names based on the weakness-------------------------//
//console.log("Function-3: Input weakness\n\n");
var a=0;
//Takes weakness from the user
function pokWeakness(weak,PokemonList) {
  //takes inputs: weakness and data store
  for (var i in PokemonList.pokemon) {
    for (var j in PokemonList.pokemon[i]) {
      for (var k in PokemonList.pokemon[i].weaknesses) {
        if (weak==PokemonList.pokemon[i].weaknesses[k]) {
          //displays the names of all pokemons which have the user input weakness
          console.log(PokemonList.pokemon[i].name);
          a++;
        }
      }
      break
  ...
  console.log("\n"+a+"pokemons have the weakness "+weak);
}
//--------------------------------------------------------//

var response=window.prompt(`Choose how you want to select your Pokemon
  1. Give the Pokemon
  2. Give the Name of the next evolution of your pokemon
  3. Give the Weakness of your pokemon`);


if (response==1) {                                          //Prompt the user to select a function
  var pokeName = window.prompt("Enter the name of the pokemon whose details you want(Case Sensitive):");
  pokInformation(pokeName,PokemonList);


} else if (response == 2) {
  var pokeName = window.prompt("Enter the name of the pokemon which is the next evolution for the desired pokemon(Case Sensitive):");
  pre_evolution(pokeName,PokemonList);


} else if (response == 3) {
  var weak = window.prompt("Give the weakness for which you want the list of pokemons(Case Sensitive):");
  pokWeakness(weak,PokemonList);
